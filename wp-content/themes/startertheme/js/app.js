...
axios
  ...
  .then(function(response) {
    ...
    response.data.map(item => mediaIds.push(item.featured_media));
    response.data.map(item => postIds.push(item.id));

    function getImage0() {
      return axios.get("/wp-json/wp/v2/media/" + mediaIds[0]);
    }

    function getImage1() {
      return axios.get("/wp-json/wp/v2/media/" + mediaIds[1]);
    }

    function getImage2() {
      return axios.get("/wp-json/wp/v2/media/" + mediaIds[2]);
    }
